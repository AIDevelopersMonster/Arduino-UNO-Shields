...
```text
@SYS,READY,MFSHIELD,LAB02,0.5
@SYS,MFSHIELD,LAB02,0.5,UNO,115200
...
```text
@STATE,uptime_ms,pot,b1,b2,b3,c1,c2,c3,l1,l2,l3,l4,buzzer_mode,display,test_state
```
